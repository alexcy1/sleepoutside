...
export function initializeSorting() {
  ...
  export async function loadProducts(displayFunction, dataSource) {
    const urlParams = new URLSearchParams(window.location.search);
...
// renderBackpack and SleepingBags Products.js =================================================
...
export class BaseData {
  constructor(category) {
    ...
    this.path = `../json/${this.category}.json`; // Dynamic path based on category
  }
